...
const navItems: NavItem[] = [
  { id: 'home', label: 'Home', path: '/home', icon: <DashboardIcon /> },
  { id: 'dashboards', label: 'Dashboard', path: '/dashboards', icon: <BarChartIcon /> },
  { id: 'processed-data', label: 'Dynamic Form', path: '/processed-data', icon: <StorageIcon /> },
  { id: 'trackerrunner', label: 'Tracker Runner', path: '/trackerrunner', icon: <RadarIcon /> },
  { id: 'reportrunner', label: 'Report Runner', path: '/reportrunner', icon: <AssignmentIcon /> },
  { id: 'investigate-runner', label: 'Investigate Runner', path: '/investigate-runner', icon: <SearchIcon /> },
